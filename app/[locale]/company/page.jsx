        ...
        <Reveal>
          {companyInfos.map((companyInfo, index) => (
            <div className="w-full flex flex-wrap md:flex-nowrap" key={index}>
              <div className="w-full md:w-[20%] mr-1 md:px-2 md:border-b-2 mt-2 md:mt-0 md:py-4 border-b-primary-green text-primary-green font-semibold">
                {companyInfo.title}
              </div>
              <div className="w-full md:w-[80%] md:px-2 border-b-2 pt-1 pb-2 md:py-4 border-b-black">
                {companyInfo.info}
              </div>
            </div>
          ))}
