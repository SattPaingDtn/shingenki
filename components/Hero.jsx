          ...
          <Reveal>
            ...
            >
              ...
              <div className="absolute top-0 left-0 flex-center w-3 md:w-6 flex-wrap">
                ...
                <div className="w-[2px] h-20 md:h-32 bg-black"></div>
              </div>
            </div>
            <div
            ...
            >
              <img
                ...
                alt="hero"
                className="w-3/4 md:w-auto md:h-auto"
              />
            </div>
            <div
              className="text-base md:text-2xl font-sail leading-6 md:leading-10 flex-center md:flex md:justify-end md:mr-[90px] mt-4 md:mt-9"
              initial={{ opacity: 0, scale: 0.5 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.5 }}
            >
